...
public class BigManaPotion extends StaticEntity {
    public BigManaPotion(Handler handler, float x, float y) {
    ...
    public void GetKilled()
    {
        ...
        handler.getWorld().getEntityManager().getPlayer().getPlayerInventoryAndStats().addItem(Item.big_mana_potion.createNew());
    }
    ...
    public void Draw(Graphics graphics) {
        graphics.drawImage(Assets.mana_potion_better, (int)(x- handler.getGameCamera().getxOffset()),  (int)(y- handler.getGameCamera().getyOffset()), width, height, null);
